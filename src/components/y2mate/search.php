...
<body>
	<header>
		<div class="sub-header">
			<a href="<?php echo $main ?>" class="header-logo" area-label="home link">
			...
			<div class="main_search">
				...
				<div class="search_box">
					<form class="main_seacrh_box" action="./search" method="POST">
						...
						<input type="text" name="url" id="url" autocomplete="off" placeholder="https://youtube.com/watch?v=URL" value="<?php echo isset($_POST['url']) ? $_POST['url'] : ''; ?>">
